...
**Results**, **Feedback**, **Graph Health**, and **Generator Preview**. A Vite + React SPA plus a
...
- **Users, Results, Feedback** read across all users and need Supabase credentials (below);
