 ...
 * lowercase, collapse internal whitespace, and trim. No edit-distance — a typo
 * is wrong. Note this only folds marks that decompose; letters with no
 * canonical decomposition (ß, ø, ł, æ) are left as-is, which the English-only
 * MVP data never exercises.
 */
